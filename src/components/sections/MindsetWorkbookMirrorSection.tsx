            ...
            <div className="max-w-[470px] space-y-8">
              {!showFullCopy ? (
                <p className="[font-family:'Poppins',sans-serif] text-[18px] font-normal leading-[1.62] text-[#26354b] sm:text-[19px] md:text-[21px] lg:text-[23px] xl:text-[24px]">
                  ...
                  <strong className="font-semibold text-[#1f2d41]">reflection</strong>. The Mindset
                  Before Millions Workbook is the practical companion to the book.{" "}
                  <button
                ...
                <p className="[font-family:'Poppins',sans-serif] text-[18px] font-normal leading-[1.62] text-[#26354b] sm:text-[19px] md:text-[21px] lg:text-[23px] xl:text-[24px]">
                  Transformation doesn&apos;t happen just by reading, it happens through{" "}
                  <strong className="font-semibold text-[#1f2d41]">reflection</strong>. The Mindset
                  Before Millions Workbook is the practical companion to the book, created to help
                  you apply its principles to your own life. Through{" "}
                  <strong className="font-semibold text-[#1f2d41]">guided prompts</strong> and
                  dedicated journaling space, this workbook invites you to examine how your pursuit
                  of success is impacting your{" "}
                  <strong className="font-semibold text-[#1f2d41]">
                    health, relationships, boundaries, and sense of fulfillment
                  </strong>
                  .
                </p>
              )}
